...
def parse_args(training=False, args=None):
    parser = argparse.ArgumentParser()

    # 保存路径和数据路径参数
    
    parser.add_argument("--root_path", type=str, default=os.environ.get("DATA_ROOT", ""))
    parser.add_argument("--save_dir", type=str, default="save_dir")
    parser.add_argument("--csv_path", type=str, default="video_paths_text_flow.csv")
