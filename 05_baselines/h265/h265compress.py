...
def compress_video(input_video, output_video, snr, qp=51, gop_size=400, preset="ultrafast", bv="100"):
    ...
    # 构建 FFmpeg 命令
    snr_config = {
        10: {"qp": 50, "gop_size": 13, "preset": "ultrafast"}, # 50, 13; 0.01105 # 51, 10; 0.01121
        8: {"qp": 51, "gop_size": 50, "preset": "ultrafast"}, # 0.008289
        6: {"qp": 51, "gop_size": 400, "preset": "ultrafast"}, # 0.007725
        4: {"qp": 51, "gop_size": 400, "preset": "ultrafast"}, #
        2: {"qp": 51, "gop_size": 400, "preset": "ultrafast"}, #
        0: {"qp": 51, "gop_size": 400, "preset": "ultrafast"}, #
    }
